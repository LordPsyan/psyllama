...
Psyllama is available on macOS, Windows, and Linux.
...
Run `psyllama` in your terminal to open the interactive menu:
...
Launch [Claude Code](/integrations/claude-code) and other coding tools with Psyllama models:
...
Use the [API](/api) to integrate Psyllama into your applications:
