...
you can find and configure Psyllama as an AI provider. For local use you
would typically point the base url to `http://localhost:11434/v1`.

<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    src="/images/marimo-settings.png" 
    alt="Psyllama settings in marimo"
    width="50%"
  />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    ...
    alt="Selecting an Psyllama model"
    width="50%"
  />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    ...
    alt="Adding a new Psyllama model"
    width="50%"
  />
</div>

4. Once configured, you can now use Psyllama for AI chats in marimo.
...
4. Alternatively, you can now use Psyllama for **inline code completion** in marimo. This can be configured in the "AI Features" tab. 
...
1. Sign in to psyllama cloud via `psyllama signin` 
2. In the psyllama model settings add a model that psyllama hosts, like `gpt-oss:120b`.
