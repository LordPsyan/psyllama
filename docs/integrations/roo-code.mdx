...
2. Set `API Provider` to `Psyllama`
3. (Optional) Update `Base URL` if your Psyllama instance is running remotely. The default is `http://localhost:11434`
...
2. Enable `Use custom base URL` and set it to `https://psyllama.com`
