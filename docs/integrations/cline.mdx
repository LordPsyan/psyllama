...
1. Open Cline settings > `API Configuration` and set `API Provider` to `Psyllama`
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    ...
    alt="Cline settings configuration showing API Provider set to Psyllama"
    width="50%"
  />
</div>
...
1. Create an [API key](https://psyllama.com/settings/keys) from psyllama.com
2. Click on `Use custom base URL` and set it to `https://psyllama.com`
3. Enter your **Psyllama API Key**
