...
2. Under **Add new credential** select **Psyllama**
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    src="/images/n8n-psyllama-form.png" 
    alt="Select Psyllama under Credential"
    width="75%"
  />
</div>
...
4. When creating a new workflow, select **Add a first step** and select an **Psyllama node** 
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    src="/images/n8n-chat-node.png" 
    alt="Add a first step with Psyllama node"
    width="75%"
  />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    ...
    alt="Set up Psyllama credentials"
    width="75%"
  />
</div>
...
2. In n8n, click **Create Credential** and select **Psyllama**
