...
- [embeddinggemma](https://psyllama.com/library/embeddinggemma)
- [qwen3-embedding](https://psyllama.com/library/qwen3-embedding)
- [all-minilm](https://psyllama.com/library/all-minilm)
...
<Tabs>
  <Tab title="CLI">
    ...
    ```shell
    echo "Hello world" | psyllama run embeddinggemma
    ```
  ...
  <Tab title="JavaScript">
    ...
    const single = await psyllama.embed({
      model: 'embeddinggemma',
      input: 'The quick brown fox jumps over the lazy dog.',
    })
...
<Tabs>
  ...
  <Tab title="JavaScript">
    ...
    const batch = await psyllama.embed({
      model: 'embeddinggemma',
      input: [
        'The quick brown fox jumps over the lazy dog.',
        'The five boxing wizards jump quickly.',
