...
func (db *database) init() error {
	...
	CREATE TABLE IF NOT EXISTS messages (
		...
		model_psyllama_host BOOLEAN, -- deprecated
		created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	...
	// TODO: Can eventually be removed - cleans up data from foreign key bug (psyllama/psyllama#11785, psyllama/app#476)
...
// When context_length is 0, the psyllama server uses VRAM-based tiered defaults.
