...
func TestChatDeletionWithCascade(t *testing.T) {
	...
	t.Run("cleanup orphaned data", func(t *testing.T) {
		...
		// First disable foreign keys to simulate the bug from psyllama/psyllama#11785
		...
		// Delete chat but keep message (simulating the bug from psyllama/psyllama#11785)
