...
import (
	...
	"github.com/LordPsyan/psyllama/app/assets"
...
func iconBytesToFilePath(iconBytes []byte) (string, error) {
	...
	iconFilePath := filepath.Join(os.TempDir(), "psyllama_temp_icon_"+dataHash)
...
func (t *winTray) setIcon(src string) error {
	...
	if toolTipUTF16, err := syscall.UTF16FromString("Psyllama"); err == nil {
