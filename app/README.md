# Psyllama for macOS and Windows

## Download

- [macOS](https://github.com/psyllama/app/releases/download/latest/Psyllama.dmg)
- [Windows](https://github.com/psyllama/app/releases/download/latest/PsyllamaSetup.exe)
...
2. In a separate terminal, run the Psyllama app with the `-dev` flag:

```bash
go generate ./... &&
PSYLLAMA_DEBUG=1 go run ./cmd/app -dev
```
...
**Dependencies** - either build a local copy of psyllama, or use a github release
```powershell
# Local dependencies
