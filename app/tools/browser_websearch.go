...
// BrowserWebSearch tool for searching the web using psyllama.com search API
...
func (w *BrowserWebSearch) Description() string {
	return "Search the web for real-time information using psyllama.com search API."
}
...
// performWebSearch handles the actual HTTP request to psyllama.com search API
