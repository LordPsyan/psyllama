	...
	m := &ModelManifest{
		Manifest: &Manifest{
			Layers: []ManifestLayer{
				{MediaType: "application/vnd.psyllama.image.tensor", Size: 1000},
				{MediaType: "application/vnd.psyllama.image.tensor", Size: 2000},
				{MediaType: "application/vnd.psyllama.image.json", Size: 500}, // not a tensor
				{MediaType: "application/vnd.psyllama.image.tensor", Size: 3000},
			},
		},
	}
...
func TestManifestAndBlobDirsRespectPSYLLAMAModels(t *testing.T) {
	modelsDir := filepath.Join(t.TempDir(), "models")

	// Simulate packaged/systemd environment
	t.Setenv("PSYLLAMA_MODELS", modelsDir)
	t.Setenv("HOME", "/usr/share/psyllama")

	// Manifest dir must respect PSYLLAMA_MODELS
	...
	// Blob dir must respect PSYLLAMA_MODELS
