// Package manifest provides documentation for the Psyllama manifest format.
...
//
//	application/vnd.psyllama.image.config; type=<type>
//
...
//
//	application/vnd.psyllama.image.template; [name=<name>]
//
...
//
//	application/vnd.psyllama.image.tensor; name=<name>; dtype=<dtype>; shape=<shape>
//
...
//
//	application/vnd.psyllama.image.tokenizer
//
// The configuration of the tokenizer is represented as a layer with the media type:
//
//	application/vnd.psyllama.image.tokenizer.config
//
// # Miscellaneous Layers
//
// These extra layer mime types are reserved:
//
//	application/vnd.psyllama.image.license
//
...
//	  "layers": [{
//	      "digest": "sha256:a...",
//	      "mediaType": "application/vnd.psyllama.image.config; type=safetensors",
//	      "size": 1234
//	    },{
//	      "digest": "sha256:b...",
//	      "mediaType": "application/vnd.psyllama.image.template",
//	      "size": 5678
//	    },{
//	      "digest": "sha256:c...",
//	      "mediaType": "application/vnd.psyllama.image.tensor; name=input; dtype=F32; shape=1,2,3",
//	      "size": 9012
//	    },{
//	      "digest": "sha256:d...",
//	      "mediaType": "application/vnd.psyllama.image.tensor; name=output; dtype=I32; shape=4,5,6",
//	      "size": 3456
//	  }]
//	}
//
// # Legacy Media Types
//
// The appliaction/vnd.psyllama.image.model media type is deprecated, but will
...
//
// The media type prefix "application/vnd.psyllama.image." is reserved for
// defining new media types for layers known to Psyllama. Currently, all other
// prefixes are ignored by official Psyllama registry clients.
package manifest
