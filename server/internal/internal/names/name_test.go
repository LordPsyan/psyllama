...
func TestParseName(t *testing.T) {
	cases := []struct {
		...
		{"psyllama.com/library/_:latest", Name{h: "psyllama.com", n: "library", m: "_", t: "latest"}},
...
func TestMerge(t *testing.T) {
	cases := []struct {
		...
		{"bmizerany/smol", "psyllama.com/library/_:latest", "psyllama.com/bmizerany/smol:latest"},
		{"localhost:8080/bmizerany/smol", "psyllama.com/library/_:latest", "localhost:8080/bmizerany/smol:latest"},
	}
	for _, tt := range cases {
